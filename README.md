...
| Pustaka Suara | Tambah, cari, edit, hapus, dan putar rekaman referensi lokal; pemeriksa format, durasi, sample rate, channel, level, clipping, dan keheningan memberi status siap/peringatan/gagal sebelum penyimpanan. |
...
2. Untuk cloning, baca panduan rekaman di Pustaka Suara lalu tambahkan WAV/MP3/FLAC/M4A/OGG/WebM. Maksimal 20 MB dan 5 menit; target kesiapan lokal adalah WAV PCM mono 15–60 detik. Berkas berstatus gagal tidak dapat disimpan. Hi-Fi memerlukan transkrip yang sama persis dengan rekaman dan menonaktifkan gaya bicara.
...
Persiapan uji kualitas tersedia pada [panduan rekaman referensi](docs/reference-recording-guide.md), [korpus 24 naskah Indonesia](docs/voice-quality-test-corpus.md), dan [rubrik evaluasi](docs/voice-quality-evaluation-rubric.md). UI Pustaka Suara juga menyediakan unduhan JSON korpus serta template CSV penilaian. Pemeriksaan lokal menilai kesiapan teknis berkas, bukan kemiripan cloning atau kualitas keluaran VoxCPM.
...
Image ekspresif tervalidasi tersebut telah diterbitkan sebagai [paket GHCR publik](https://github.com/users/Muhira007/packages/container/package/voxcpm-studio-worker) melalui [run 35856643949](https://github.com/Muhira007/VoxCPM-Studio/actions/runs/35856643949). Gunakan referensi tetap `ghcr.io/muhira007/voxcpm-studio-worker@sha256:763938c78e0d1be4ccb968ab6dd7a351b6a14be5b7f8001e7c04540df7df6071`; jangan memakai tag `latest`. Tag commit dilindungi dari overwrite oleh workflow. Manifest tag dan digest telah diuji dengan pull anonim, tetapi image belum dijalankan pada GPU.
